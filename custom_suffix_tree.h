...
void add_suffix_in_node_sons_2(suffix_tree_node* root,const char* suffix,int suffix_len,int suffix_index,vector<int> icfl_list,vector<int> cusotm_icfl_list,int lenght_of_word,vector<int> is_custom_vec);
